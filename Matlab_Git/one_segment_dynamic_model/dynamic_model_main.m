...
pressure_total(2,:) = 0.1;
pressure_total(7,:) = 0.1;
pressure_total(9,:) = 0.1;
...
for i =  2:pressure_size %6967
 dt =(pressure_time(i)-pressure_time(i-1));
   ...
   [generalized_force_term_] = GetGeneralizedForceTerm(w_H_1h_, dw_H_1h__dq1_,dw_H_1h__dq2_, dw_H_1h__dq3_, real(q_1_), real(q_2_), real(q_3_), 10^5*pressure_total(2,i-1), 10^5*pressure_total(7,i-1), 10^5*pressure_total(9,i-1), q_dot_)
