...
for i =  2:pressure_size
   ...
   [generalized_force_term_] = GetGeneralizedForceTerm(w_H_1h_, dw_H_1h__dq1_,dw_H_1h__dq2_, dw_H_1h__dq3_, q_1_, q_2_, q_3_, 10^5*pressure_total(2,i-1), 10^5*pressure_total(7,i-1), 10^5*pressure_total(9,i-1), q_dot_);
   ...
   generalized_force_term_container(:,i-1) = subs(generalized_force_term_,[q_1_n,q_2_n, q_3_n],[q_1_, q_2_, q_3_]);
   ...
   %p = t*0.15
   %pressure_total(2,i) =  1000*t*0.6 + 0.05; %let pressure increase linearly
   if q_2_ > 0.315 || q_1_ > 0.315 || q_3_ > 0.315
       k= 0
   end
