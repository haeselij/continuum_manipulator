...
d_M_1_bend_dq1 = C_1*d_theta_dq_q1;
d_M_1_bend_dq2 = C_1*d_theta_dq_q2;
d_M_1_bend_dq3 = C_1*d_theta_dq_q3;
  end
bending_stiffness_derivative(1,1) = roundn(d_M_1_bend_dq1 ,10);
bending_stiffness_derivative(2,1) = roundn(d_M_1_bend_dq2 ,10);
bending_stiffness_derivative(3,1) = roundn(d_M_1_bend_dq3 ,10);
