syms q_1 q_2 q_3 r_b C phi kappa l_bar
...
%%
% 
% d_w_H_dk(1:4,1) = d_w_H_1h_dphi(:,1);
% d_w_H_dk(5:8,1) = d_w_H_1h_dphi(:,2);
% d_w_H_dk(9:12,1) = d_w_H_1h_dphi(:,3);
% d_w_H_dk(13:16,1) = d_w_H_1h_dphi(:,4);
% 
% d_w_H_dk(1:4,2) = d_w_H_1h_dkappa(:,1);
% d_w_H_dk(5:8,2) = d_w_H_1h_dkappa(:,2);
% d_w_H_dk(9:12,2) = d_w_H_1h_dkappa(:,3);
% d_w_H_dk(13:16,2) = d_w_H_1h_dkappa(:,4);
% 
% d_w_H_dk(1:4,3) = d_w_H_1h_dl_bar(:,1);
% d_w_H_dk(5:8,3) = d_w_H_1h_dl_bar(:,2);
% d_w_H_dk(9:12,3) = d_w_H_1h_dl_bar(:,3);
% d_w_H_dk(13:16,3) = d_w_H_1h_dl_bar(:,4);
%%
% 
for i=1:3
    for k=1:3
...
%%
if 4*(1-2*sin(phi)^2)*(1-cos(l_bar*kappa)) == d2_w_H_1h_dphidphi(1,1)
