...
for i = 1:numOfIterations
    ...
    [q_(:,i+1), v_(:,i+1)] = SolveSystemEulerForward(D_damp_spline_, m_, g_, C_ohne_l_bar_, q_0_, A_, k_, D_damp_, r_b_, k_spline_, q_(1,i), q_(2,i), q_(3,i), v_(1,i), v_(2,i), v_(3,i), q_1_dot, q_2_dot, q_3_dot, v_1_dot, v_2_dot, v_3_dot, p_(1,i), p_(2,i), p_(3,i));
    time(1,i) = dt*i - dt;
end
