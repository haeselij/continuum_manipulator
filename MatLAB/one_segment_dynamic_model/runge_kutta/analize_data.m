...
exp_3_start = 14353;
exp_3_end = 18040;
q_exp_1(:,:) = q_exp(:,exp_3_start:exp_3_end);
q_model_1(:,:) = q_(:,1:20001); 

exp_1_time = length_time(exp_3_start:exp_3_end) -78.29 + 0.62;
exp_1_time_converted = seconds(exp_1_time);

for i = 1 : 20001
   model_1_time(i) = 0.001*i; 
end
...
ex_1_timetable.Properties.VariableNames = {'q_2exp','q_1exp','q_3exp'};
